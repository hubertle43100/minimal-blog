...
export default async function OneMinuteArticle({
  params,
}: {
  params: { slug: string };
}) {
  ...
  return (
    <div className="mb-10 mt-8">
      <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700 p-6 rounded-md bg-gray-50">
        <header className="pt-6 xl:pb-6">
          <div className="space-y-1 text-left">
            <div className="space-y-10">
              <div>
                <p className="text-base font-medium leading-6 text-primary mb-2">
                  One minute read of the day
                </p>
              </div>
            </div>
